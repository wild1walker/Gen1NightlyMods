...
- Version bump only; see the Gen1WildUI nightly changelog for 0.32.88.

## [0.32.87] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.87.

## [0.32.86] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.86.

## [0.32.85] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.85.

## [0.32.84] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.84.

## [0.32.83] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.83.

## [0.32.82] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.82.

## [0.32.81] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.81.

## [0.32.80] - 2026-09-06

### Changed

- Version bump only; see the Gen1WildUI nightly changelog for 0.32.80.

## [0.32.79] - 2026-09-06

### Changed

- Version bump only. Both changes are UI; see the Gen1WildUI nightly
  changelog for 0.32.79.

## [0.32.78] - 2026-09-06

### Changed

- Version bump only. Both fixes are UI; see the Gen1WildUI nightly
  changelog for 0.32.78.
...
- Version bump only. The animation fix is a UI change; see the Gen1WildUI
  nightly changelog for 0.32.76.

## [0.32.75] - 2026-09-06

### Changed

- Version bump only. The #DEX plate is a UI change; see the Gen1WildUI
  nightly changelog for 0.32.75.

## [0.32.74] - 2026-09-06

### Changed

- Version bump only. The picture cut-outs are a UI change; see the
  Gen1WildUI nightly changelog for 0.32.74.
...
- Version bump only. The picture cut-outs are a UI change; see the
  Gen1WildUI nightly changelog for 0.32.73.
...
- Version bump only. The dex pic placeholder is a UI change; see the
  Gen1WildUI nightly changelog for 0.32.70.

## [0.32.69] - 2026-09-06

### Changed

- Version bump only. The undiscovered dex entry on Gold is a UI change; see
  the Gen1WildUI nightly changelog for 0.32.69.
...
- Version bump only. The dex entry's plate is a UI fix; see the Gen1WildUI
  nightly changelog for 0.32.67.
